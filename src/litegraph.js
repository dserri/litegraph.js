...
(function(global) {
	...
	general properties:
		...
		+ inputs_horizontal: input slots are distributed horizontally (overrides horizontal for inputs, set to null to use horizontal)
		+ outputs_horizontal: output slots are distributed horizontally (overrides horizontal for outputs, set to null to use horizontal)
